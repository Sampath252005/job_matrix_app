...
export const createAssessment = async (payload, token) => {
...
export const getAssessmentByJob = async (jobId, recruiterId, token) => {
    const supabase = getSupabase(token);
    return supabase
        .from("assessments")
        .select("*")
...
export const getAssessmentById = async (assessmentId, recruiterId, token) => {
    const supabase = getSupabase(token);
    return supabase
        .from("assessments")
        .select("*")
...
export const updateAssessment = async (assessmentId, recruiterId, payload, token) => {
    const supabase = getSupabase(token);
    return supabase
        .from("assessments")
        .update(payload)
...
export const deleteAssessment = async (assessmentId, recruiterId, token) => {
    const supabase = getSupabase(token);
    return supabase
        .from("assessments")
        .delete()
...
export const startAssessment = async (assessmentId, candidateId, token) => {
    const supabase = getSupabase(token);
...
export const saveAnswer = async (attemptId, candidateId, questionId, selectedAnswer, token) => {
    const supabase = getSupabase(token);
...
export const submitAssessment = async (attemptId, candidateId, token) => {
    const supabase = getSupabase(token);
    // Verify attempt
    const { data: attempt, error: attemptError } = await supabase
        .from("assessment_attempts")
...
export const getAssessmentResult = async (attemptId, status, token) => {
    const supabase = getSupabase(token);
...
export const getCandidateAssessments = async (candidateId, token) => {
    const supabase = getSupabase(token);
...
export const getAssessmentResults = async (assessmentId, recruiterId, token) => {
    const supabase = getSupabase(token);
...
export const getAttempt = async (attemptId, candidateId, token) => {
    const supabase = getSupabase(token);
    ...
    if (error)
        throw error;
    const assessmentId = attempt.assessments.id;
...
//# sourceMappingURL=assessments.services.js.map