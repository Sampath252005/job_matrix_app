import * as candiaterServices from "./profile.service.js";
export const updateCandidateProfile = async (req, res) => {
    try {
        ...
        const { education, college, degree, branch, graduation_year, experience_level, skills, resume_url, portfolio_url, location, job_type_preference, } = req.body;
        ...
        const { data, error } = await candiaterServices.upsertCandidateProfileDetails({
            user_id: userId,
