...
import { getApplicationsByJob, getAllShortlistedApplication, updateApplicationStatus, applyToJob, getMyApplications, getApplicationById, deleteApplication } from "./applications.controller.js";
const router = express.Router();
//------------------------------------------recruiter side routes--------------------------------------
// Get all applications for a job
router.get("/job/:jobId", protect, allowRoles("ADMIN", "RECRUITER"), getApplicationsByJob);
router.get("/job/:jobId/shortlisted", protect, allowRoles("ADMIN", "RECRUITER"), getAllShortlistedApplication);
...
router.delete("/:applicationId", protect, allowRoles("ADMIN", "CANDIDATE"), deleteApplication);
